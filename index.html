...
<html lang="en">
  <head>
    ...
    <meta
      property="og:url"
      content="https://github.com/rounakc2k/Speech-text-to-handwritten-text"
    />
    <meta
  ...
  <body>
    <main>
      ...
      <h1>Speech/Text to Handwritten Text conversion</h1>
      <section style="font-size: 1rem; padding: 20px 0px;">
        <div>
          
          <ul class="info-ul">
            <li>
              You can import your handwritten .ttf or .otf  font file 
              with "Upload your Handwriting Font" button.
            </li>
            <li>
              Click in the speech recognition dialog box to enter your speech and the text will be generated.
              <li>
              Copy the text generated and paste it in the ruled sheet where the text will be converted into handwritten text.
            </li>
            </li>
          </ul>
          <br />
      ...
      <section>
        ...
        <div id="output" class="output" style="text-align: center;">
          Click "Generate Image" Button to generate the page.
        </div>
    ...
    <footer style="padding: 40px 0px 10px 0px;">
      Thank you for using Speech/Text to Handwriting text conversion !
    </footer>
